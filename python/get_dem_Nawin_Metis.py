...
def event_info(data_disk, data_disk_date):
    ...
    cadence = 60*u.minute #cadence of AIA images
    ...
    bottom_left = SkyCoord(-600*u.arcsec, -900*u.arcsec, frame= map.coordinate_frame)
    bottom_left_pix = skycoord_to_pixel(bottom_left, map.wcs, origin = 0)*u.pixel
    top_right = SkyCoord(-100*u.arcsec, 900*u.arcsec, frame= map.coordinate_frame)
    top_right_pix = skycoord_to_pixel(top_right, map.wcs, origin = 0)*u.pixel
...
if __name__ == '__main__':
    ...
    data_disk = '/disk/solarz3/nn2/CHBSOOP_2023/data/'
    ...
    data_disk_date = ['2023/04/09','2023/04/10']
    #select only 1 day
    # output_dir = '/disk/solarz3/nn2/LucieFL/results/'
    output_dir = '/disk/solarz3/nn2/CHBSOOP_2023/results/DEM/'
